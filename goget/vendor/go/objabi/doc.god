...
//
//	- cmd/go/goobj/read.go (used by cmd/addr2line, cmd/nm, cmd/objdump, cmd/pprof)
//	- cmd/go/obj/objfile.go (used by cmd/asm and cmd/compile)
//	- cmd/link/go/objfile.go (used by cmd/link)
//
